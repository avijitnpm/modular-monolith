...
func (m *mockUserCreator) CreateUser(_ context.Context, organizationID, identityID, email string) (string, error) {
	if m.err != nil {
		return "", m.err
	}
	if m.userID == "" {
...
func (m *mockIdentityChecker) HasMembership(_ context.Context, identityID string) (bool, error) {
	return m.has, m.err
}
