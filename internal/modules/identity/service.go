...
type Store interface {
	...
	GetMemberships(ctx context.Context, identityID string) ([]MembershipReference, error)
}
...
func (s *Service) GetMemberships(ctx context.Context, identityID string) ([]MembershipReference, error) {
	return s.Repository.GetMemberships(ctx, identityID)
}
